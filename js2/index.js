window.addEventListener("load",function(){
    ...
    project_select_array.forEach(function(project,idx){
        project.addEventListener("click",function(){
            terryfic_hero.innerHTML = `
                <ul>
                    <li class="hero_section_project">
                        <div class="hero_img" id="hero_img">
                            <img src="${project_array[idx].img}" alt="${project_array[idx].title}">
                        </div>
                        <section class="hero_txt">
                            <figure><img src="${project_array[idx].logo}" alt="${project_array[idx].title} 로고"></figure>
                            <div class="terryfic_hero_title">
                                <img src="${project_array[idx].top}" alt="${project_array[idx].idx + 1}번 프로젝트">
                                <h3>${project_array[idx].title}</h3>
                            </div>
                            <div class="terryfic_hero_txt">
                                <span>${project_array[idx].txt}</span>
                            </div>
                            <div class="terryfic_hero_btn">
                                <div class="terryfic_hero_btn_top">
                                    <a href="${project_array[idx].publish}" target="_blank" class="btn_common btn_play"><img src="./img/btn_play.svg" alt="재생버튼">퍼블리싱사이트</a>
                                    <a href="#" class="btn_common btn_info btn_info_project"><img src="./img/btn_info.svg" alt="인포버튼">상세 정보</a>
                                </div>
                                <div class="terryfic_hero_btn_bottom">
                                    <a href="${project_array[idx].figma}" target="_blank" class="btn_common btn_play"><img src="./img/btn_play.svg" alt="재생버튼">피그마 프로토타입</a>
                                </div>
                            </div>
                        </section>
